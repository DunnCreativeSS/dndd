...
int main(int argc, char** argv) {
   ...
   try {
      ...
      std::cerr << "------------------------------------------------------\n";
      auto initminer_private_key = graphene::utilities::key_to_wif( DNDLIT_INIT_PRIVATE_KEY );
      std::cerr << "initminer public key: " << DNDLIT_INIT_PUBLIC_KEY_STR << "\n";
      std::cerr << "initminer private key: " << initminer_private_key << "\n";
      std::cerr << "chain id: " << std::string(DNDLIT_CHAIN_ID) << "\n";
      std::cerr << "blockchain version: " << fc::string( DNDLIT_BLOCKCHAIN_VERSION ) << "\n";
      std::cerr << "------------------------------------------------------\n";
#else
      std::cerr << "------------------------------------------------------\n\n";
      std::cerr << "            STARTING DNDL NETWORK\n\n";
      std::cerr << "------------------------------------------------------\n";
      std::cerr << "initminer public key: " << DNDLIT_INIT_PUBLIC_KEY_STR << "\n";
      std::cerr << "chain id: " << std::string(DNDLIT_CHAIN_ID) << "\n";
      std::cerr << "blockchain version: " << fc::string( DNDLIT_BLOCKCHAIN_VERSION ) << "\n";
      ...
      bpo::options_description app_options("DNDL Daemon");
      bpo::options_description cfg_options("DNDL Daemon");
      ...
      {
         std::cout << "steem_blockchain_version: " << fc::string( DNDLIT_BLOCKCHAIN_VERSION ) << "\n";
